    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-rose-50 p-6">
      <div className="max-w-screen mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 ">
          <div className="flex items-center justify-between max-w-screen w-full">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="bg-pink-50 p-2.5 pl-3 pr-3 text-md text-pink-600 rounded-md  hover:bg-pink-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
              Log Symptoms
              </button>
              <button
        ...
        <div className="mb-8 flex justify-center">
          <button
            ...
            className="px-8 py-3 bg-red-600 text-white rounded-xl hover:bg-red-700 font-bold text-lg shadow-lg transition duration-200"
          >
            🚨 Emergency Alert
          </button>
        </div>
