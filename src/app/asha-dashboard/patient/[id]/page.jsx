    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-rose-50 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* Symptom Logs */}
          <div className="lg:col-span-2 bg-white rounded-xl shadow-lg p-8 border border-pink-100">
            ...
            {!patient.symptomLogs || patient.symptomLogs.length === 0 ? (
              <div className="text-center py-12 text-gray-500">
                ...
                <p className="text-sm mt-2">
                  Encourage patient to log their symptoms.
                </p>
              </div>
            ) : (
                ...
                {patient.symptomLogs.map((log) => (
                  ...
                  >
                    <div className="flex justify-between mb-4">
                      ...
                      <span className="text-sm text-gray-500 bg-pink-100 px-3 py-1 rounded-full">
                    ...
                    {log.symptoms?.map((symptom, i) => (
                      <div
                        key={i}
                        className="bg-gradient-to-r from-pink-50 to-rose-50 p-4 rounded-lg mb-3"
                      >
                        <div className="flex justify-between mb-2">
                          ...
                          <span
                            className={`px-3 py-1 text-xs font-bold rounded-full ${getSeverityColor(
                              symptom.severity
                            )}`}
                          >
                            {symptom.severity}
                        ...
                        {symptom.description && (
                          <p className="text-sm text-gray-700 bg-white p-3 rounded-lg border border-pink-200 italic mt-2">
                            "{symptom.description}"
                          </p>
                        )}
                      </div>
                    ...
                    {log.additionalNotes && (
                      <p className="mt-4 bg-yellow-50 p-4 rounded-lg border-l-4 border-pink-400 italic">
                        "{log.additionalNotes}"
                      </p>
                    )}
                  </div>
